...
const typeNum = (arr) => {
  // Solution code here...
  var newArr = arr.filter(value => !isNaN(value));
  return newArr;
...
const containsAnd = (arr) => {
  // Solution code here...
  var newArr = arr.filter(value => value.includes('and'));
  return newArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  var newArr = arr.filter(value => value % 2 === 1);
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  var newArr = arr.filter(x => !forbiddenValues.includes(x))
  return newArr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  var newArr = arr.filter(x => x.baseStat > minBaseStat)
  return newArr;
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  var newArr = arr.filter(x => x.baseStat > minBaseStat).map(x => {return x.stat.name})
  return newArr;
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  var newArr = arr.filter(x => !x.children)
  return newArr;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  var newArr = arr.filter(value => typeof(value) === 'number').map(x=> x % 2 === 0 ? 'even' : 'odd');
  return newArr;
