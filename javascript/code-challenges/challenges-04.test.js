...
const sortByPrice = (arr) => {
  // Solution code here...
  var newArr = arr.sort(function(a,b){return a.price-b.price});
  return newArr;
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  var newArr = arr.sort(function(a,b){return a.toString().length - b.toString().length});
  return newArr;
};
...
const sortPeopleBetter = (arr) => arr.sort((personA, personB) => {
  var personAlast = personA.lastName.toLowerCase();
  var personBlast = personB.lastName.toLowerCase();
  var personBfirst = personB.firstName.toLowerCase();
  var personAfirst = personA.firstName.toLowerCase();
  var age1 = personA.age;
  var age2 = personB.age;
  return personAlast === personBlast && personAfirst === personBfirst ? age1 - age2 : personAlast === personBlast && personAfirst < personBfirst? -1: personAlast === personBlast && personAfirst > personBfirst ? 1 : personAlast < personBlast ? -1 : 1;
});
...
const sortMeetingsByDay = (arr) => {
  ...
  var newArr = arr.sort(function(a,b){return day[a.dayOfWeek]- day[b.dayOfWeek]});
  return newArr;
};
...
const sortSchedule = (arr) => arr.sort((meetingA, meetingB) => {
  var lengthA = meetingA.end - meetingA.start;
  var lengthB = meetingB.end - meetingB.start;
  return meetingA.dayOfWeek === meetingB.dayOfWeek && meetingA.start === meetingB.start ? lengthA - lengthB : meetingA.dayOfWeek === meetingB.dayOfWeek && meetingA.start < meetingB.start ? -1 : 1
});
